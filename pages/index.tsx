...
function Splash() {
  ...
  return (
    <PageSpacer style={{ paddingBottom: 0 }}>
          ...
          <Grid container direction='column'>
            ...
            <Grid item className={classes.spacerBottom}>
              <Typography variant='body1'>
                ...
                design patterns. I am very passionate about the future of the web and the technologies that drive it.
                I've had the opportunity to work on a wide variety of systems including full-stack apps/websites, motion
